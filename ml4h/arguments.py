...
def parse_args():
    ...
    parser.add_argument('--encoder_blocks', nargs='*', default=['conv_encode', 'fc'], choices=list(BLOCK_CLASSES), help='List of encoding blocks.')
    parser.add_argument('--merge_blocks', nargs='*', default=['concat'], choices=list(BLOCK_CLASSES), help='List of merge blocks.')
    parser.add_argument('--decoder_blocks', nargs='*', default=['conv_decode', 'fc_decode'], choices=list(BLOCK_CLASSES), help='List of decoding blocks.')
